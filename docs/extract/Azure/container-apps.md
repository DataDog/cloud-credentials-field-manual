...
[Azure Container Apps](https://azure.microsoft.com/en-us/products/container-apps) is a platform to run modern apps and microservices using serverless containers.
